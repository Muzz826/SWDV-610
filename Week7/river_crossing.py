...
def boat_ride(left_bank, boat, right_bank):
    '''
    ...
    right_bank['cannibals'] += 1 
    cp_status(left_bank, boat, right_bank)
    boat_ride(left_bank, boat, right_bank)
...
# Ouputs where each cannibal & missionary are after each boat ride
    print(curr_stage.format(cp1['cannibals'], cp1['missionaries'], cp2['cannibals'], cp2['missionaries'], cp3['cannibals'], cp3['missionaries']))
